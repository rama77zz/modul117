...
@enderror" type="text" name="firstName" id="firstName" value="{{ old('firstName')
...
@enderror" type="text" name="lastName" id="lastName" value="{{ old('lastName') }}"
...
old('position') == $position->id ? 'selected' : '' }}>{{ $position->code.' -
